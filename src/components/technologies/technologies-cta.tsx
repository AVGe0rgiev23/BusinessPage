...
export function TechnologiesCta() {
  return (
    <Section id="get-started" aria-labelledby="technologies-cta-heading">
      <Container>
        <Reveal>
          <div className="relative isolate overflow-hidden rounded-3xl border border-border bg-bg-surface px-6 py-16 text-center md:px-12 md:py-24">
            ...
            <h2
              id="technologies-cta-heading"
              className="mx-auto mt-4 max-w-3xl text-balance text-h1 font-semibold text-text-primary"
            >
              Want to talk through the right approach for your project?
            </h2>
            <p className="mx-auto mt-5 max-w-2xl text-pretty text-body-lg text-text-secondary">
              Book a free consultation and we&apos;ll walk through what to build,
              how it fits the systems you already run, and the stack that makes
              sense for your goals. Plain language, no jargon.
            </p>

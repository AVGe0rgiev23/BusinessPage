...
/**
 * ProcessCta — closing conversion block for the Process page. Matches the
 * styling of `home/closing-cta.tsx` with Process-specific copy, funnelling to
 * `/book` (primary) and `/contact` (secondary). Server Component.
 */
export function ProcessCta() {
  return (
    <Section id="get-started" aria-labelledby="process-cta-heading">
      <Container>
        <Reveal>
          <div className="relative isolate overflow-hidden rounded-3xl border border-border bg-bg-surface px-6 py-16 text-center md:px-12 md:py-24">
            ...
            >
              See exactly how we&apos;d approach your project.
            </h2>
            <p className="mx-auto mt-5 max-w-2xl text-pretty text-body-lg text-text-secondary">
              Book a free consultation and we&apos;ll walk you through what the
              first steps would look like for your business — the problem worth
              solving, the plan to solve it, and what it would take. No pressure,
              no jargon.
            </p>

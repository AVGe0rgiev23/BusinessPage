...
export function FaqCta() {
  return (
    <Section id="still-have-questions" aria-labelledby="faq-cta-heading">
      <Container>
        <Reveal>
          <div className="relative isolate overflow-hidden rounded-3xl border border-border bg-bg-surface px-6 py-16 text-center md:px-12 md:py-24">
            ...
            >
              The quickest answer is a conversation.
            </h2>
            <p className="mx-auto mt-5 max-w-2xl text-pretty text-body-lg text-text-secondary">
              If your question isn&apos;t here, ask us directly. Book a free
              consultation and we&apos;ll talk through your situation — no jargon,

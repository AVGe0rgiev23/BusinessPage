...
/**
 * AboutCta — closing conversion block for the About page. Matches the styling
 * of `home/closing-cta.tsx` with About-specific copy, funnelling to `/book`
 * (primary) and `/contact` (secondary). Server Component.
 */
export function AboutCta() {
  return (
    <Section id="get-started" aria-labelledby="about-cta-heading">
      <Container>
        <Reveal>
          <div className="relative isolate overflow-hidden rounded-3xl border border-border bg-bg-surface px-6 py-16 text-center md:px-12 md:py-24">
            ...
            >
              If that&apos;s how you&apos;d want it built, let&apos;s talk.
            </h2>
            <p className="mx-auto mt-5 max-w-2xl text-pretty text-body-lg text-text-secondary">
              ...
              is losing time and money — and whether custom software is the right
              way to win it back. Honest answers either way.
            </p>
